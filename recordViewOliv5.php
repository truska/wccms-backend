  ...
  if (($actionRequest !== '' || $showRequest !== null) && $actionRecordId > 0) {
    ...
    if ($sets) {
      try {
        ...
        header('Location: ' . $CMS_BASE_URL . '/recordViewOliv5.php?frm=' . urlencode((string) ($form['id'] ?? '')));
        exit;
...
<div class="cms-shell">
  ...
  <main class="cms-content">
    <div class="cms-content-header">
      ...
      <div>
        <a class="btn btn-primary" href="<?php echo $CMS_BASE_URL; ?>/recordNewOliv5.php?frm=<?php echo cms_h((string) ($form['id'] ?? '')); ?>">Add New</a>
      </div>
    </div>
                            ...
                            <?php foreach ($actions as $action): ?>
                              ...
                              if ($href === '#' || $href === '') {
                                ...
                                if ($slug === 'edit' || $labelLower === 'edit') {
                                  $href = 'recordEditOliv5.php?frm=[frm]&id=[id]';
                              ...
                              if (str_contains($href, 'recordEditv4.php')) {
                                $href = str_replace('recordEditv4.php', 'recordEditOliv5.php', $href);
                              }
                              if (str_contains($href, 'recordEditv5.php')) {
                                $href = str_replace('recordEditv5.php', 'recordEditOliv5.php', $href);
                              }
                              if (str_contains($href, 'recordViewv5.php')) {
                                $href = str_replace('recordViewv5.php', 'recordViewOliv5.php', $href);
                              }
                              ...
                              if (str_contains($href, 'recordViewOliv5.php') && (str_contains($href, 'act=') || str_contains($href, 'show='))) {
                                $actionType = '';

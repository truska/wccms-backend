			...
			<div class="content">
				...
				<form role="form" class="form-horizontal" method="post" enctype="multipart/form-data">
					...
					foreach ($form_fields as $rowformfield) {
						...
						$FORMFIELD = new FormField($rowformfield, $rowfield, '', $TypeDebug, $infomark);
						...
						if ($rowfield["id"] == 118) // New Slug Creation Select Statement From Table
						{
							...
							if ($rowformfield["tooltip"]) {
								echo "<a href='#' data-toggle='tooltip' title='" . $rowformfield["tooltip"] . "'>" . $infomark . "</a>";
								if ($TypeDebug == 'Yes') {
					...
					<div class='form-group'>
						<button data-popover="popover" data-content="Save" data-placement="top" data-trigger="hover" type="submit" name="submit" class="btn btn-success" id="sbt"><i class="fa fa-check"></i>Save New Record</button>
					</div>
				</form>
